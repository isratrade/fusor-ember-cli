...
export default Ember.Route.extend(NeedsExistingManifestHelpers, {
  ...
  validate() {
    ...
    return request({
      url: `${window.fusorServer}/fusor/api/v21/deployments/${deploymentId}/validate`,
      type: "GET",
      headers: {
  ...
  syncOpenStack() {
    ...
    return request({
      url: `${window.fusorServer}/fusor/api/v21/openstack_deployments/${openstack_deployment.get('id')}/sync_openstack`,
      type: "POST",
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json",
